...
# Brennerlec emission index

[![REUSE Compliance](https://github.com/noi-techpark/webcomp-a22-emission-index/actions/workflows/reuse.yml/badge.svg)](https://github.com/noi-techpark/odh-docs/wiki/REUSE#badges)
[![REUSE status](https://api.reuse.software/badge/github.com/noi-techpark/webcomp-a22-emission-index)](https://api.reuse.software/info/github.com/noi-techpark/webcomp-a22-emission-index)
[![CI/CD](https://github.com/noi-techpark/webcomp-a22-emission-index/actions/workflows/main.yml/badge.svg)](https://github.com/noi-techpark/webcomp-a22-emission-index/actions/workflows/main.yml)

A responsive webcomponent for showing the environmental impact associated to the real-time traffic on the A22 highway

- [Brennerlec emission index](#brennerlec-emission-index)
  - [Usage](#usage)
...
```html
<script type="module" src="./noi-a22-emission-index.js"></script>
```

Define the web component like this:

```html
  <noi-a22-emission-index></noi-a22-emission-index>
```
...
noi-a22-emission-index.dark::part(marker) {
  background: #333;
...
noi-a22-emission-index.dark::part(marker-icon) {
  color: currentColor;
}
```
...
```bash
git clone https://github.com/noi-techpark/webcomp-a22-emission-index.git
```

Change directory:

```bash
cd webcomp-a22-emission-index/
```
